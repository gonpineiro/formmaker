...
const setDataTip = (element) => {
    ...
    switch (element.field_type) {
        ...
        case 'email':
            ...
            dataTip += 'Placeholder: ' + (element.field_placeholder || '-') + '<br />';
...
const InfoField = ({ element, handlerDeleteField, innerRef, dragHandleProps, draggableProps }) => {
    return (
        <div className="card mb-1" ref={innerRef} {...dragHandleProps} {...draggableProps}>
            <div data-for="main" data-tip={setDataTip(element)} className="card">
                <div className="card-header d-flex align-items-center pb-2 pt-2">
                    ...
                    <div className="col-3">{element.field_placeholder || element.url || ''}</div>
                ...
                <div className="card-body" style={{ padding: '0.5rem 1rem' }}>
                    <div className="col-3">
                        {element.field_label || element.separator_description || element.link_title}
                    </div>
                </div>
            </div>
